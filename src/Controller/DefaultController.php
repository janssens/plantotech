...
class DefaultController extends AbstractController
{
    ...
    public function contact(Request $request)
    {
        if ($request->isMethod('POST')) {
            ...
            if ($e = $this->mailer->sendMail($email_address,'ton message a bien été transmit','contact_form',[
                'name' => $name,
                'mail' => $email_address,
                'subject' => $subject,
                'message' => $message,
                ...
                if ($e = $this->mailer->sendMail($this->config->getValue('app/main_email'),'contact : '.$subject,'contact_to',[
                    'name' => $name,
                    'mail' => $email_address,
                    'subject' => $subject,
                    'message' => $message,
