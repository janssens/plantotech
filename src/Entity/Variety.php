...
class Variety
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="varieties")
     */
    private $author;

    /**
     * @ORM\ManyToOne(targetEntity=Plant::class, inversedBy="varieties")
     */
    private $parent;

    /**
     * @ORM\OneToMany(targetEntity=Source::class, mappedBy="variety", orphanRemoval=true)
     */
    private $sources;

    /**
     * @ORM\ManyToMany(targetEntity=AttributeValue::class, mappedBy="varieties")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=Image::class, mappedBy="Variety", orphanRemoval=true,cascade={"persist"})
     */
    private $images;
    ...
    {
        return self::makeSlug($this->getParent()->getLatinName().'_'.$this->getName());
    }
