 ...
 */
final class Version20200511161439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE humidity (id INT AUTO_INCREMENT NOT NULL, quantity VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE need_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE interest_value (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, name VARCHAR(20) NOT NULL, INDEX IDX_F9D7B9BFC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE interest_value_plant (interest_value_id INT NOT NULL, plant_id INT NOT NULL, INDEX IDX_D6E6E35485F32E62 (interest_value_id), INDEX IDX_D6E6E3541D935652 (plant_id), PRIMARY KEY(interest_value_id, plant_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE interest_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE insolation_plant ADD CONSTRAINT FK_E99AB3E1C80C469C FOREIGN KEY (insolation_id) REFERENCES insolation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE insolation_plant ADD CONSTRAINT FK_E99AB3E11D935652 FOREIGN KEY (plant_id) REFERENCES plant (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE need_value ADD CONSTRAINT FK_FB2F4B7CC54C8C93 FOREIGN KEY (type_id) REFERENCES need_type (id)');
        $this->addSql('ALTER TABLE need_value_plant ADD CONSTRAINT FK_3338665583F6FF68 FOREIGN KEY (need_value_id) REFERENCES need_value (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE need_value_plant ADD CONSTRAINT FK_333866551D935652 FOREIGN KEY (plant_id) REFERENCES plant (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE interest_value ADD CONSTRAINT FK_F9D7B9BFC54C8C93 FOREIGN KEY (type_id) REFERENCES interest_type (id)');
        $this->addSql('ALTER TABLE interest_value_plant ADD CONSTRAINT FK_D6E6E35485F32E62 FOREIGN KEY (interest_value_id) REFERENCES interest_value (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE interest_value_plant ADD CONSTRAINT FK_D6E6E3541D935652 FOREIGN KEY (plant_id) REFERENCES plant (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE need_value DROP FOREIGN KEY FK_FB2F4B7CC54C8C93');
        ...
        $this->addSql('ALTER TABLE insolation_plant DROP FOREIGN KEY FK_E99AB3E11D935652');
        $this->addSql('ALTER TABLE need_value_plant DROP FOREIGN KEY FK_333866551D935652');
        ...
        $this->addSql('ALTER TABLE interest_value_plant DROP FOREIGN KEY FK_D6E6E3541D935652');
        ...
        $this->addSql('ALTER TABLE insolation_plant DROP FOREIGN KEY FK_E99AB3E1C80C469C');
        $this->addSql('ALTER TABLE need_value_plant DROP FOREIGN KEY FK_3338665583F6FF68');
        ...
        $this->addSql('ALTER TABLE interest_value_plant DROP FOREIGN KEY FK_D6E6E35485F32E62');
        $this->addSql('ALTER TABLE interest_value DROP FOREIGN KEY FK_F9D7B9BFC54C8C93');
        ...
        $this->addSql('DROP TABLE need_type');
        ...
        $this->addSql('DROP TABLE insolation_plant');
        $this->addSql('DROP TABLE need_value');
        $this->addSql('DROP TABLE need_value_plant');
        ...
        $this->addSql('DROP TABLE interest_value');
        $this->addSql('DROP TABLE interest_value_plant');
