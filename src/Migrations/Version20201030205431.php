 ...
 */
final class Version20201030205431 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD confirmation_token VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE rp_token rp_token VARCHAR(255) DEFAULT NULL, CHANGE rp_token_created_at rp_token_created_at DATETIME DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D6493F275AB ON user (rp_token)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE plants_insolations CHANGE insolation_id insolation_id INT DEFAULT NULL, CHANGE ideal ideal TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('DROP INDEX UNIQ_8D93D6493F275AB ON user');
        $this->addSql('DROP INDEX UNIQ_8D93D649C05FB297 ON user');
        $this->addSql('ALTER TABLE user DROP confirmation_token, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`, CHANGE rp_token rp_token VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE rp_token_created_at rp_token_created_at DATETIME DEFAULT \'NULL\'');
    }
}
