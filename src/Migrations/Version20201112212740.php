 ...
 */
final class Version20201112212740 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE attribute_values (id INT AUTO_INCREMENT NOT NULL, attribute_id INT NOT NULL, value VARCHAR(255) DEFAULT NULL, INDEX IDX_184662BCB6E62EFA (attribute_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE attribute_values_plant (attribute_values_id INT NOT NULL, plant_id INT NOT NULL, INDEX IDX_38BE3E462712FDC (attribute_values_id), INDEX IDX_38BE3E41D935652 (plant_id), PRIMARY KEY(attribute_values_id, plant_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE attribute (id INT AUTO_INCREMENT NOT NULL, family_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, type SMALLINT NOT NULL, code VARCHAR(50) NOT NULL, INDEX IDX_FA7AEFFBC35E566A (family_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE attribute_values_plant ADD CONSTRAINT FK_38BE3E462712FDC FOREIGN KEY (attribute_values_id) REFERENCES attribute_values (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE attribute_values_plant ADD CONSTRAINT FK_38BE3E41D935652 FOREIGN KEY (plant_id) REFERENCES plant (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE attribute_values_plant DROP FOREIGN KEY FK_38BE3E462712FDC');
        ...
        $this->addSql('ALTER TABLE attribute_values_plant DROP FOREIGN KEY FK_38BE3E41D935652');
        ...
        $this->addSql('DROP TABLE attribute_values_plant');
